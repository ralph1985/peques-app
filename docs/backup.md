...
La copia es un JSON sin cifrar con `format: "peques-backup"`, `schemaVersion: 4`, `exportedAt` en UTC y `data` con todas las tablas documentadas en el esquema. Incluye los hijos, pesos, medidas de crecimiento, la fecha de primer uso, la selección activa, comunidad sanitaria, cita, preguntas de consulta, cronómetros en curso, categorías, ubicaciones y ambos órdenes de Viaje. Las copias v1, v2 y v3 se pueden importar; las antiguas sin fecha de primer uso usan su fecha de exportación como referencia.
