...
La primera visita a cada pantalla principal muestra un tutorial breve y local, con opción para marcar esa pantalla como vista o saltar el tutorial completo. El progreso forma parte de `settings` y se conserva sin usar localStorage ni red. La aplicación recuerda la copia pendiente cuando no existe una exportación o han pasado más de 14 días desde la última.
